            ...
            <div>
              ...
              <div className="mt-12 p-6 bg-primary-50 dark:bg-primary-900/20 rounded-lg">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="https://www.linkedin.com/in/joan-rodriguez-hidalgo-56a2a1b6/" className="text-secondary-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-200">
